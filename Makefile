...
SMOOTHING ?= 30
ZOOM ?= 5
EXTRA_GOALS := $(filter-out help rgbGraph rgbCorrect aiCorrect stitch clean cleanCorrected,$(MAKECMDGOALS))

.PHONY: help rgbGraph rgbCorrect aiCorrect stitch clean cleanCorrected
.PHONY: $(EXTRA_GOALS)
